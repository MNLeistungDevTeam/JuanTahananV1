...
public partial class DMSDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Applican__3214EC073D903035");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Barrower__3214EC0753092C32");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Form2Pag__3214EC070741320D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Spouse__3214EC079F7F0095");

...
public class UserRepository : IUserRepository
{
    ...
    public async Task<List<UserModel>> GetUserByCompanyId(int? companyId) =>
        (await _db.LoadDataAsync<UserModel, dynamic>("spUser_GetUsersByCompanyId", new { companyId })).ToList();

...
$(async function () {
    ...
    function loadApplications() {
        let info_for_dev_approval = $("#info_for_dev_approval");
        ...
        $.ajax({
            ...
            beforeSend: function () {
                info_for_dev_approval.html(loading_text);
            ...
            success: function (response) {
                info_for_dev_approval.html(`<span data-plugin="counterup">${response.NeedsDeveloperApproval}</span>`);
            ...
            error: function (error) {
                info_for_dev_approval.html(`<span data-plugin="counterup">${0}</span>`);

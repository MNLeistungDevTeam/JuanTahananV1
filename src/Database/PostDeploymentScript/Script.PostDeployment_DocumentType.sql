...
INSERT [dbo].[DocumentType] ([Id],Code, [Description], [DateCreated], [CreatedById], [DateModified], [ModifiedById], [DateDeleted], [DeletedById]) VALUES  (26, N'WLF252', N'Pag-IBIG Buyers Confirmation (BCF)', CAST(N'2024-02-24T08:35:48.1374701' AS DateTime2), 1, NULL, NULL, NULL, NULL);
...
INSERT [dbo].[DocumentType] ([Id],Code, [Description], [DateCreated], [CreatedById], [DateModified], [ModifiedById], [DateDeleted], [DeletedById],[ParentId]) VALUES  (36, N'HLF-1X1PIC', N'1 x 1 ID Picture (Attached to HLF)', CAST(N'2024-02-24T08:35:48.1374701' AS DateTime2), 1, NULL, NULL, NULL, NULL,2);

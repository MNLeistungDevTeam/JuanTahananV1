...
BEGIN
	...
	INSERT [dbo].[ModuleType](Id, [Description], Icon, Ordinal, Controller, [Action], IsDisabled, IsVisible, InMaintenance, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (5, N'Setup', N'<i class="mdi mdi-cogs me-1"></i>', 5, N'', N'', CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 1, 1, GETDATE(), NULL, NULL)
...
BEGIN
	...
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (4, N'USER-ACC', N'User Account', 5, 0, N'', N'User', N'Index', 29, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 1, 1, GETDATE(), NULL, NULL)
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (5, N'ROLE', N'Role Management', 5, 1, N'', N'Role', N'Index', 29, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 1, 1, GETDATE(), NULL, NULL)
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (6, N'APPROVER-MGMT', N'Approver Management', 5, 2, NULL, N'ApproverManagement', N'Index', 29, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 0, 1, GETDATE(), NULL, NULL)
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (7, N'BNF-MGMT', N'Benefiary Management', 3, 0,'<i class="mdi mdi-format-list-text"></i>', N'Beneficiary', N'Index', NULL, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'True'), 0, 1, GETDATE(), NULL, NULL)
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (8, N'APLCT-MGMT', N'Applicants Management', 3, 1, NULL, N'Applicants', N'Index', NULL, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'True'), 0, 1, GETDATE(), NULL, NULL)
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (9, N'COMP', N'Company', 6, 0, NULL, N'CompanyProfile', NULL, NULL, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 0, 1, GETDATE(), NULL, NULL)

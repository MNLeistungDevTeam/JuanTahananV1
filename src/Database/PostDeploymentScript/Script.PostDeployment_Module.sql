...
BEGIN
	...
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (1, N'HOME', N'Dashboard', 1, 0, N'<i class="fe-airplay me-1"></i>', N'Home', N'Index', NULL, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 1, 1, GETDATE(), NULL, '2023-12-07 17:40:19.3000000')
	...
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (9, N'COMP', N'Company', 5, 6,  N'<i class="fe-airplay me-1"></i>', N'CompanyProfile',  N'Index', NULL, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 0, 1, GETDATE(), NULL, NULL)
	...
	INSERT [dbo].[Module](Id, Code, [Description], ModuleTypeId, Ordinal, Icon, Controller, [Action], ParentModuleId, ApprovalRouteTypeId, IsDisabled, InMaintenance, IsVisible, WithApprover, CompanyId, CreatedById, DateCreated, ModifiedById, DateModified) VALUES (13, N'APLHLF-NEW', N'Housing Loan Form', 1, 2, N'<i class="mdi mdi-form-select"></i>', N'Applicants',  N'NewHLF068', NULL, NULL, CONVERT(bit, 'False'), CONVERT(bit, 'False'), CONVERT(bit, 'True'), CONVERT(bit, 'False'), 0, 1, GETDATE(), NULL, NULL)

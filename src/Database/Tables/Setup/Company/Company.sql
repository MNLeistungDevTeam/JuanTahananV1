...
(
    ...
    [BusinessStyle] NVARCHAR(50) NULL, 
    ...
    [RepresentativeTin] NVARCHAR(50) NULL,
    [RepresentativeDesignation] NVARCHAR(100) NULL,
    [PostingPeriod] INT NULL,
    [AccountingPeriod] NVARCHAR(25) NULL,
    [AcctngPeriodFrom] NVARCHAR(50) NULL,
    [AcctngPeriodTo] NVARCHAR(50) NULL,
    [InvEvalMethodId] INT NULL,
    ...
    [IsRequiredDailySetCurrency] BIT NULL DEFAULT 0
...
CREATE TRIGGER [dbo].[Trigger_Company_ColumnUpdates] ON [dbo].[Company] --Change to match your table name
...
SET @TABLE_NAME = 'Company'; ---Change to your table name
IF(@Action = 'Create')
BEGIN

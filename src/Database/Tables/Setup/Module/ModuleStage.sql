...
(
    ...
    [Level] INT NOT NULL, 
    [ApproveDesc] NVARCHAR(50) NOT NULL, 
...
CREATE TRIGGER [dbo].[Trigger_ModuleStage_ColumnUpdates] ON [dbo].[ModuleStage] --Change to match your table name
...
SET @TABLE_NAME = 'ModuleStage'; ---Change to your table name
IF(@Action = 'Create')
BEGIN
